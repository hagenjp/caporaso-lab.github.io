...
There is not an undergraduate or graduate bioinformatics program at NAU, but there are some courses that will start to prepare you for a career in bioinformatics. Biology, Computer Science and Statistics are the most relevant undergraduate degrees. If you're interested in a graduate degree, you may want to do that in the `Biology Department <http://nau.edu/CEFNS/NatSci/Biology/Degrees-Programs/Graduate/>`_. or in the `School of Informatics, Computing and Cybersystems <https://nau.edu/siccs/>`_. You would then work with a faculty member whose research is bioinformatics-heavy, and they would guide you toward relevant coursework.
